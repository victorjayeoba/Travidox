...
export function Footer() {
  ...
  const productLinks: FooterLink[] = [
    { name: "Stock Trading", href: "/dashboard/markets" },
    { name: "Trading Bot", href: "/dashboard/trading-bot" },
    { name: "Learning Center", href: "/dashboard/learn" },
    { name: "Certifications", href: "/dashboard/certifications" },
  ];
    ...
    <footer className="bg-gray-900 text-white py-10 md:py-14 lg:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-10">
          {/* Brand and Description - takes 3 columns on large screens */}
          <div className="lg:col-span-3 space-y-4 md:space-y-5 order-1">
            ...
            <div className="flex items-start space-x-4">
              <Button variant="outline" size="sm" className="border-green-500 text-green-500 hover:bg-green-500 hover:text-white text-xs md:text-sm">
          ...
          {/* Legal section - takes 3 columns on large screens, positioned at top-right on desktop */}
          <div className="lg:col-span-3 order-5 md:order-2">
